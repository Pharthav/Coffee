...
%\begin{multicols}{2} 
We developed models to predict the cooling timescale of  a cup of coffee utilising Newton's law of cooling and the heat equation. A theoretical model based on the heat equation predicted that the coffee would cool down to 320.0 K from 360.5 K in 52 minutes whereas an experimental data fit showed it should take 34 minutes. Finally, we investigated thermal convection within the coffee using the Lattice Boltzmann Method (LBM) to solve Navier-Stokes equations.
...
}{Using a digital probe thermometer, we measured the temperature of a cup of hot coffee over time at room temperature of 290 K. The starting temperature of the coffee ranged between 358 - 363 K.
